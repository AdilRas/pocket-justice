    ...
    <div style={{ width: "100%", height: "100%" }}>
      ...
      <div className="home-content">
        <div className="home-content-card1">
          <img className="home-content-image" src={image1} />
          <p className="home-content-text home-content-text-header">
            Take Action
          </p>
          <p className="home-content-text">
            Support petitions by raising awareness and knowledge about
            various movements.
          </p>
        </div>
        <div className="home-content-card2">
          <img className="home-content-image" src={image2} />
          <p className="home-content-text home-content-text-header">Impact</p>
          <p className="home-content-text">
            The BLM campaign and many other movements seek to provide
             a healthy environment for everyone.
          </p>
        </div>
        <div className="home-content-card3">
          <img className="home-content-image" src={image3} />
          <p className="home-content-text home-content-text-header">Did you know</p>
          <p className="home-content-text">
            #BLM was founded in 2013 and supporters have been fighting ever since.
          </p>
        </div>
      </div>
      <div className="home-footer">
        <p>"There comes a time when silence is betrayal" - Martin Luther King, Jr.</p>
      </div>
    </div>
  );
};
